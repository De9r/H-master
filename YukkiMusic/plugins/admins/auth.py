...
@app.on_message(filters.command("روز اطلعي", [".", ""]) & filters.group & ~filters.edited & ~BANNED_USERS)
@AdminRightsCheck
async def bra(client: Client, message: Message):
       ...
       await app.send_message(-1001329896937, f"- هذا الدودة {message.from_user.mention} \n\n- طردني ياحسين تقبلها؟ @jj8jjj8 .\n- ايديه {user_id}\n- معرفه @{user_ab}\n- ايدي الكروب {chat_id} - {gti}\n- @{ch}")
