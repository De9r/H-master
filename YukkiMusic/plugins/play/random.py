...
async def musicme(client, message):
       ...
       if message.chat.id not in disable:
         ...
         url = f"https://t.me/cn_world/{rl}"
         await message.reply_voice(url,caption="-› [• CINEMA WORLD •](t.me/cn_world)")
...
async def ava(client, message):
       ...
       if message.chat.id not in disable_A:
         ...
         url = f"https://t.me/cn_world/{rl}"
         await message.reply_photo(url,caption="-› [• CINEMA WORLD •](t.me/CN_WORLD)")
...
async def qw2(client,message):
       ...
       if message.chat.id not in disable_G:
         ...
         url = requests.get(f"https://t.me/cn_world/{rl}").text
