    ...
    await query.edit_message_media(
       ...
       reply_markup=InlineKeyboardMarkup(
          [
               [
                    InlineKeyboardButton(
                        "◌sᴏᴜʀᴄᴇ rose◌", url=f"t.me/cn_world"),
                    InlineKeyboardButton(
                        "◌ᴅᴇᴠᴇʟᴏᴘᴇʀ◌", url=f"t.me/jj8jjj8")
                ],[
                    InlineKeyboardButton(
                        "", callback_data="close"),
                    InlineKeyboardButton(
...
async def back1(_, query: CallbackQuery):
    ...
    await query.edit_message_media(
       InputMediaVideo(
           ...
           "**اهلا فيك في قسم تشغيل المنصات**\n- **المنصات المدعومة هي ↓**\n\n**• Telegram\n• Youtube\n• SoundCloud\n• AppleMusic\n• Spotify\n\n- بتلكه شرح لكل هالمنصات بالزرار تحت ..**"
       ),
       reply_markup=InlineKeyboardMarkup(
            [
                [
                     ...
                     InlineKeyboardButton(
                        "◌sᴏᴜʀᴄᴇ rose◌", callback_data=f"fft"),
...
async def donnr(_, query: CallbackQuery):
    ...
    await query.edit_message_media(
       InputMediaVideo(
           ...
           "**هلا فيك في قسم تشغيل روابط اليوتيوب\n\n• عندك طريقتين للتشغيل وهي :\n\n1 - وضع الرابط مع الامر \n2 - بالرد على الرابط بأمر التشغيل وهو [ روز شغلي ]\n\n◌ مثال : روز شغلي https://youtu.be/UuEPuVjsoG4\n- تابع الفيديو فوك للتوضيح اكثر ،**"
       ),
       reply_markup=InlineKeyboardMarkup(
            [
                [
...
async def apple(_, query: CallbackQuery):
    ...
    await query.edit_message_media(
       InputMediaVideo(
           ...
           "◌ هلا فيك في قسم تشغيل اغاني Apple Music ♪\n\n• يمكنك تشغيل الاغاني عن طريق الرد على الرابط او وضعه مع الامر .\n\n• مثال : [ `روز شغلي https://music.apple.com/sa/album/ipad/1616715862?i=1616715870&l=ar` ]\n\n**تابع الفيديو للتوضيح اكثير .**"
       ),
       reply_markup=InlineKeyboardMarkup(
            [
                [
...
async def spo(_, query: CallbackQuery):
    ...
    await query.edit_message_media(
       InputMediaVideo(
           ...
           "◌ هلا فيك في قسم تشغيل اغاني Spotify ♪\n\n• يمكنك تشغيل الاغاني عن طريق الرد على الرابط او وضعه مع الامر .\n\n• مثال : [ `روز شغلي https://open.spotify.com/track/2GQB3Xe1J9D2sK90AtHfhI?si=aIuly9l-T-Gy5GvfZxpUiw&context=spotify%3Aplaylist%3A37i9dQZF1DXcJUwMZo8Ss1i=1616715870&l=ar` ]\n\n**تابع الفيديو للتوضيح اكثير .**"
       ),
       reply_markup=InlineKeyboardMarkup(
            [
                [
